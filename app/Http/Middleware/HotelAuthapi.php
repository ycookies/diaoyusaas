...
// 酒店 授权接口中间件
class HotelAuthapi extends BaseMiddleware
{
    ...
    public function handle($request, Closure $next)
    {
        ...
        /*try {
            $interface_v = $request->get('interface_v',1);
