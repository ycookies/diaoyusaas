...
// 列表
class ProfitsharingOrderReceiverController extends AdminController
{
    ...
    {
        return Grid::make(new ProfitsharingOrderReceiver(), function (Grid $grid) {
    ...
    {
        return Show::make($id, new ProfitsharingOrderReceiver(), function (Show $show) {
            $show->field('id');
            $show->field('hotel_id');
    ...
    {
        return Form::make(new ProfitsharingOrderReceiver(), function (Form $form) {
            $form->display('id');
            $form->text('hotel_id');
