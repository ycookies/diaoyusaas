...
class HelpController extends AdminController
{
    ...
    protected function grid()
    {
        return Grid::make(Help::with('type'), function (Grid $grid) {
            ...
            $grid->tools('<a class="btn btn-white btn-outline" target="_blank" href="' . admin_url('help-type') . '">管理分类</a>');
    ...
    protected function form()
    {
        return Form::make(new Help(), function (Form $form) {
            ...
            $form->select('type_id','所属文章分类')->options(HelpType::where(['hotel_id'=> Admin::user()->hotel_id])->pluck('name','id'))->required();
            //$form->text('click');
