...
class Hotel extends HotelBaseModel {

    protected $table = 'hotel';
    //public $timestamps = false;
    public $guarded = [];

    protected $appends = ['early_arrival_time','late_arrival_time','early_departure_time','late_departure_time','hotel_img']; //
    ...
    public function device(){
        return $this->hasMany(HotelDevice::class, 'hotel_id', 'id')->orderBy('ID','DESC');
    }
    // 房间
    ...
    public function goldplan() {
        return $this->hasOne(HotelGoldPlan::class, 'hotel_id', 'id');
    }
}
