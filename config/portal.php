...
return [
    ...
    */
    ...
    |
    */
    'logo' => '<img src="/vendor/dcat-admin/images/logo.png" width="35"> &nbsp;钓友邦<span style="font-size: 12px;">服务商</span>',
   ...
   */
    ...
    */
    'auth' => [
        ...
        'controller' => App\Portal\Controllers\AuthController::class,
    ...
    */
    'database' => [
        ...
        'users_table' => 'portal_users',
        'users_model' => \App\Portal\Models\PortalUser::class,

        // Role table and model.
        'roles_table' => 'portal_roles',
        'roles_model' => \App\Portal\Models\PortalRole::class,

        // Permission table and model.
        'permissions_table' => 'portal_permissions',
        'permissions_model' => \App\Portal\Models\PortalPermission::class,// Dcat\Admin\Models\Permission::class,

        // Menu table and model.
        'menu_table' => 'portal_menu',
        'menu_model' => \App\Portal\Models\PortalMenu::class,

        // Pivot table for table above.
        'role_users_table'       => 'portal_role_users',
        'role_permissions_table' => 'portal_role_permissions',
        'role_menu_table'        => 'portal_role_menu',
        'permission_menu_table'  => 'portal_permission_menu',
        'settings_table'         => 'portal_settings',
        'extensions_table'       => 'portal_extensions',
        'extension_histories_table' => 'portal_extension_histories',
    ],
