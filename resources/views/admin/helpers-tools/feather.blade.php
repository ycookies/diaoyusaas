...
<div>
    <div class="feather-icons overflow-hidden row">
        <div class="col-md-4 col-sm-6 col-12 fonticon-container clipboard-txt" data-clipboard-text='feather icon-activity'>
            <div class="fonticon-wrap">
                <i class="feather icon-activity"></i>
            </div>
            <label class="fonticon-classname mt-1">icon-activity</label>
        </div>
        <div class="col-md-4 col-sm-6 col-12 fonticon-container clipboard-txt" data-clipboard-text='feather icon-airplay'>
            <div class="fonticon-wrap">
                <i class="feather icon-airplay"></i>
            </div>
            <label class="fonticon-classname mt-1">icon-airplay</label>
        </div>
        <div class="col-md-4 col-sm-6 col-12 fonticon-container clipboard-txt" data-clipboard-text='feather icon-alert-circle'>
            <div class="fonticon-wrap">
