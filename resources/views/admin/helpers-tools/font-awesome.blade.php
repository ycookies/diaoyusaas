<div class="">
    <section>
        ...
        <div class="icon-list-demo row">
            <div class="col-sm-6 col-md-4 col-lg-3 clipboard-txt" data-clipboard-text='fa fa-bluetooth'><i class="fa fa-bluetooth"></i>fa fa-bluetooth</div>

            <div class="col-sm-6 col-md-4 col-lg-3 clipboard-txt" data-clipboard-text='fa fa-bluetooth-b'><i class="fa fa-bluetooth-b"></i>fa fa-bluetooth-b</div>

            <div class="col-sm-6 col-md-4 col-lg-3 clipboard-txt" data-clipboard-text='fa fa-codiepie'><i class="fa fa-codiepie"></i>fa fa-codiepie</div>

            <div class="col-sm-6 col-md-4 col-lg-3 clipboard-txt" data-clipboard-text='fa fa-credit-card-alt'><i class="fa fa-credit-card-alt"></i>fa fa-credit-card-alt</div>
