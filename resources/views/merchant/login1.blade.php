...
<div class="row login-main" style="background-image: url('/images/gw-bg2.jpg');background-repeat: repeat;background-position: center;background-size: cover;">

    <div class="col-lg-9 col-12 login-page-right">

        <div class="content-front">
            <div style="text-align: left;">
                <img src="/images/logo-03.jpg" width="180">
            </div>
            <div style="margin-top: 200px;margin-left: 60px;font-size: 36px;font-weight:700;text-align: left;color:#a73b0a">
                专注星级酒店自运营SaaS系统
            </div>
        </div>
    ...
    <div class="col-lg-3 col-12 login-box">
        <div class="login-page">
            {{--<div class="auth-brand text-lg-left">
                &nbsp;商家版<span style="font-size: 12px;"></span>
            </div>--}}

            <div class="login-box">
                <div style="font-size: 32px;font-weight:700;text-align: center;background:#FFFFFF;padding: 10px 0px;border-bottom: 1px solid #eeeeee"> 商家版</div>
                <div class="login-logo">
                    <h4 class="mt-0">高效链接每一位客人</h4>
