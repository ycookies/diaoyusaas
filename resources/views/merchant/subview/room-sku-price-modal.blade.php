<div class="modal fade" id="room-sku-price-modal" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="room-price-form" action="{{url('/merchant/calendar-sku-price-save')}}" method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        ...
                        <input type="hidden" name="room_sku_id" id="room_sku_id" value="">
