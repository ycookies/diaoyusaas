...
<header class="mui-bar mui-bar-nav">
    ...
    <h1 class="mui-title">
        酒店客服中心
        <div class="mui-sub-title">{{$hotel_name}}</div>
    </h1>
</header>
<pre id='h'></pre>
<div class="main">
    <div id='msg-list'>
        @foreach ($msglist as $items)
            <div class="msg-item @if($items->msg_to == 2) msg-item-self @endif">
                @if($items->msg_to == 2)
                    <i class="msg-user mui-icon mui-icon-person"></i>
                @else
                    <img class="msg-user-img" src="/img/user1.png" alt="" onerror="this.src='/img/user1.png'"/>
                @endif
                    <div class="msg-content">
                        <div class="msg-content-inner">
                            @if($items->msg_type == 'text')
                                {!! $items->msg_content !!}
                            @endif

                            @if($items->msg_type == 'image')
                                    <img class="msg-content-image" data-preview-src="" data-preview-group="1" src="{{$items->msg_content}}" style="max-width: 100px;" />
                            @endif
                            @if($items->msg_type == 'voice')
                                    {{--<a class="amrnb"  href="{{$items->msg_content}}" download=""><span class="mui-icon mui-icon-mic"></span></a>--}}
                                    <div style="min-width: 100px;" onclick="playAMR('{{$items->msg_content}}');">
                                        <img src="/js/amr/play-icon.png" width="24">
                                    </div>
                            @endif
...
<div class="footer">
    <!--<div class="footer-left">
        <i id='msg-image' class="mui-icon mui-icon-camera" style="font-size: 28px;"onclick="alert('暂时无法使用')"></i>
    </div>-->
    ...
    <label for="" class="footer-right">
        <a id='msg-send' onclick="send()" class='input-sound mui-btn mui-btn-success'><span class="loadings"></span> 发送
        </a>
